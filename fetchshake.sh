...
if [ $# -eq 1 ]
 ...
 echo "<h2>MyShake: seismology for the masses!</h2>
  ...
  The network consists of many stations scattered throughout <a href=\"https://raspberryshake.net/stationview/\"> the world</a> that do their part to contribute to the data, and even the detection, of the seismic activity that occurs on <a href=\"https://raspberryshake.net/eqview/\">this planet.</a></p>
  <p>The following is the most recent helicorder image for the detector at this location - <a href=\"https://raspberryshake.net/stationview/#?net=$stat_id_1&sta=$stat_id_2\">$stat_id_1.$stat_id_2</a><br>
  </p><p>
